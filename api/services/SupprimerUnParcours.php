...
$idTraceAsupprimer = ( empty($this->request['idTrace'])) ? "" : $this->request['idTrace'];
...
{	$msg = "Erreur : méthode HTTP incorrecte.";
    ...
    if ( $pseudo == "" || $mdpSha1 == "" || $idTraceAsupprimer == "" )
    {	$msg = "Erreur : données incomplètes.";
        $code_reponse = 400;
    }
    else
    {	// contrôle d'existence de traceAsupprimer
    	    $uneTrace = $dao->getUneTrace($idTraceAsupprimer);
    	    if ($uneTrace == null)
