...
class Point
{
    ...
    public static function getDistance (Point $point1, Point $point2) {
        ...
        $latidudePoint1 = $point1->getLatitude();
        $longitudePoint1 = $point1->getLongitude();
        $latitudePoint2 = $point2->getLatitude();
        $longitudePoint2 = $point2->getLongitude();
        
        return Point::getDistanceBetween($latidudePoint1, $longitudePoint1, $latitudePoint2, $longitudePoint2);
    }
