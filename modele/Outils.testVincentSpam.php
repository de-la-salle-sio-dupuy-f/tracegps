...
$j = substr($uneDateFR, 0, 2);
$m = substr($uneDateFR, 3, 2);
$a = substr($uneDateFR, 6, 4);
$uneDateUS = $a."-".$m."-".$j;
...
$ok = false;
$i = 0;
$tab = array("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p");
$nbtab = count($tab);
while ($i<$nbtab);
    
    $adresseEmetteur = $tab(i)."@gmail.com";
    $adresseDestinataire = "delasalle.sio.dupuy.f@gmail.com";
